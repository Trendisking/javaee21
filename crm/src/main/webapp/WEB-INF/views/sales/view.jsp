                ...
                <div class="box-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td style="width: 200px"><a href="/customer/${sales.customerid}" target="_blank">${sales.customername}</a></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="savLogeBtn">保存</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="progressForm"  action="/sales/progress/edit" method="post">
                    <input name="id" value="${sales.id}" type="hidden">
                    <div class="form-group">
                        <label>当前进度</label>

                        <select name="progress" class="form-control">
                            <option value="初次接触">初次接触</option>
                            <option value="确认意">确认意向</option>
