            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right" >
                        <button  id="newBtn" class="btn btn-xs btn-success"><i class="fa fa-plus"></i> 新增英雄</button>
                    </div>
                </div>
                <div class="box-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="newForm">
                    ...
                    <div class="form-group">
                        <label>英雄等级</label>
                        <select type="level" class="form-control">
                            <option value=""></option>
                            <option value="★">★</option>
                            <option value="★★">★★</option>
                            <option value="★★★">★★★</option>
           ...
           //ajax请求服务端获取id对应的customer对象和公司列表
            $.get("/customer/edit/"+id+".json").done(function(data){
                if(data.state=="success"){
                    ...
                    //判断customer是否是公司，如果是公司的话则隐藏所属公司列表
